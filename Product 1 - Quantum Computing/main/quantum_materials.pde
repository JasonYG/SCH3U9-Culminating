...
void semiconductor_continued() {
  ...
  text("With these properties in mind, InGaAs has great potential to be used as the basic working \nunit of a quantum chip, which is similar to a transistor on a silicon chip (Abate, 2017).", 50, 450);
}